...
\setlength{\parindent}{1cm} % Define o tamanhado da identação do parágrafo como 3cm
...
\hspace{5cm} % Define o tamanhado da identação apenas desse parágrafo para 1+5cm
...
\vspace{2cm} % Define o espaçamento  apenas entre esses dois parágrafos para 0.5+2cm
