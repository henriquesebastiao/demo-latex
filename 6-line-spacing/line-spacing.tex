...
\setlength{\parindent}{3cm} % Define o tamanhado da identação do parágrafo como 3cm
...
\onehalfspacing % Espaçamente entre linhas de 1.5
...
\doublespacing % Espaçamente entre linhas de 2
...
\setstretch{4} % Espaçamente personalizado entre linhas de 3
...
\begin{onehalfspace} % Aplica espaçamento em apenas um parágrafo específico
